...
class MytoryBoard
{
    ...
    /**
     * @var array roleByBoard가 true인 경우 전체 공개 게시판의 슬러그를 적는다.
     */
    public $publicBoardSlugs = [ 'public' ];

    /**
     * @var array roleByBoard가 true인 경우 회원 공개 게시판의 슬러그를 적는다.
     */
     ...
     * @type array   $publicBoardSlugs    : roleByBoard가 true인 경우 전체 공개 게시판의 슬러그를 적는다. Default ['public']
     * @type array   $memberBoardSlugs    : roleByBoard가 true인 경우 회원 공개 게시판의 슬러그를 적는다. Default ['member']
    ...
    public function registerBoardTaxonomy()
    {
        $labels = [
     ...
     * @param $post_id
     */
    public function defaultMytoryBoard($post_id)
    {
    ...
    public function slugToId($post_id, \WP_Post $post, $is_update)
    {
    ...
    public function setThumbnail($post_id, \WP_Post $post, $is_update)
    {
     ...
     * @param          $is_update
     */
    public function addBoardTermToPost($post_id, \WP_Post $post, $is_update)
    {
    ...
    public function increasePageView()
    {
